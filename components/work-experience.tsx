...
export function WorkExperience({
  ...
  return (
    <div className={cn("bg-background px-6 text-foreground max-w-4xl mx-auto", className)}>
          ...
          <div className="relative z-1 flex items-center gap-2 pl-9 text-sm text-muted-foreground">
            ...
            <dl>
              ...
              <dd className="flex items-center gap-0.5 tabular-nums">
                ...
                {isOngoing ? (
                  <HugeiconsIcon icon={Infinity01Icon} strokeWidth={2} className="size-4.5 translate-y-[0.5px]" aria-label="Present" />
                ) : (
                  <span>{end}</span>
                )}
              </dd>
...
//   const [mm, yyyy] = `${fallbackMonth === "last" ? "12" : "01"}.${str}`
//     .split(".")
//     .map(Number)
//   if (fallbackMonth === "last") {
//     return new Date(yyyy, mm, 0)
